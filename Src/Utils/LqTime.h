...
static const size_t LqTimeGmtStrLen = sizeof("Mon, 28 Sep 1970 06:00:00 GMT");
static const size_t LqTimeStrLen = sizeof("Wed Feb 13 16:06:10 2013");
...
LQ_IMPORTEXPORT int LQ_CALL LqTimeStrToLocTm(const char* lqain lqacp Str, struct tm* lqaout Result);
LQ_IMPORTEXPORT int LQ_CALL LqTimeStrToGmtTm(const char* lqain lqacp Str, struct tm* lqaout Result);
...
LQ_IMPORTEXPORT int LQ_CALL LqTimeGmtTmToStr(char* lqaout lqacp DestStr, LqTimeSec DestStrLen, const struct tm* lqain InTmGmt);
LQ_IMPORTEXPORT int LQ_CALL LqTimeLocTmToStr(char* lqaout lqacp DestStr, LqTimeSec DestStrLen, const struct tm* lqain InTm);
...
LQ_IMPORTEXPORT void LQ_CALL LqTimeLocSecToLocTm(struct tm* lqaout Tm, LqTimeSec LocalTime);
LQ_IMPORTEXPORT void LQ_CALL LqTimeLocSecToGmtTm(struct tm* lqaout Tm, LqTimeSec LocalTime);
...
LQ_IMPORTEXPORT void LQ_CALL LqTimeGetLocTm(struct tm* lqaout Tm);
LQ_IMPORTEXPORT void LQ_CALL LqTimeGetGmtTm(struct tm* lqaout Tm);
