...
LOCAL_CFLAGS		:= $(OPTIM_CFLAGS) -w -std=c++0x -fPIC -fvisibility=hidden -fvisibility-inlines-hidden -fno-use-cxa-atexit
LOCAL_MODULE		:= mdlautoload
LOCAL_SHARED_LIBRARIES := lanq_lib
LOCAL_LDFLAGS		:= $(OPTIM_CFLAGS) -shared -nostartfiles -fvisibility=hidden -fvisibility-inlines-hidden -fno-use-cxa-atexit
